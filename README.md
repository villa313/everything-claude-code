...
- **Public surface synced to the live repo** — metadata, catalog counts, plugin manifests, and install-facing docs now match the actual OSS surface: 64 agents, 249 skills, and 82 legacy command shims.
...
**That's it!** You now have access to 64 agents, 249 skills, and 82 legacy command shims.
...
| Commands | PASS: 82 commands   | PASS: 35 commands | **Claude Code leads** |
...
| **Commands** | 82                    | Shared | Instruction-based | 35 | 6 prompts |
